...
if [ "$ARCH" = "aarch64" ] || [ "$ARCH" = "arm64" ]; then
    URL="https://github.com/masterking32/MasterDnsVPN/releases/download/v2026.03.16.194017-11256ef/MasterDnsVPN_Server_Linux_ARM64.zip"
    ...
    if [ $LEGACY -eq 1 ]; then
        ...
        URL="https://github.com/masterking32/MasterDnsVPN/releases/download/v2026.03.16.194017-11256ef/MasterDnsVPN_Server_Linux-Legacy_AMD64.zip"
        PREFIX="MasterDnsVPN_Server_Linux-Legacy_AMD64"
    else
        URL="https://github.com/masterking32/MasterDnsVPN/releases/download/v2026.03.16.194017-11256ef/MasterDnsVPN_Server_Linux_AMD64.zip"
